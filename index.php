...
<html>
    ...
    <h2 id = "directions">Select a puzzle</h2><br>
    
    <?php

    $sql1 = "SELECT `value` FROM `preferences` WHERE `name`= 'NO_OF_PUZZLES_PER_ROW'";
    $sql2 = "SELECT `name` FROM `gpuzzles` ORDER BY RAND() LIMIT 12";
    $sql3 = "SELECT `puzzle_image` FROM `gpuzzles` ORDER BY RAND() LIMIT 12";
    ...
    for($a=0;$a<$count;$a){
        ...
        echo "
        <td>
				<a href = 'display_puzzle.php?topic=$topic' title = $topic>
					<image class = 'image' src = gpuzzles/Images/puzzle_images/$pic></image>
