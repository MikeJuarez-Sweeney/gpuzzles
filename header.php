...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <a href="index.php" title="SILC Quiz Master"><img id="silc" src="Images/index_images/puzzles_logo.jpg" width="300" height="140"></a> 
        ...
        <li class="nav-item">
            ...
            if (isset($_SESSION['role'])){
                echo '<li class="nav-item active"><a class="nav-link" id="header" href="puzzles_list.php">Puzzle List<span class="sr-only">(current)</span></a>';
