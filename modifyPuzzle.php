...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      <div>
        <label for="facilitator">Booke Name</label>
      ...
      <div>
        ...
        <input type="text" class="form-control" name="puzzle_image" value="'.$row["puzzle_image"].'"  maxlength="255" style=width:400px required><br>
      </div>

      <div>
        <label for="required">Solution Image</label>
        <input type="text" class="form-control" name="solution_image" value="'.$row["solution_image"].'"  maxlength="255" style=width:400px required><br>
      </div>
